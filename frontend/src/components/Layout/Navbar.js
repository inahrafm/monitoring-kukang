...
const Navbar = ({ toggleSidebar, sidebarOpen, user }) => {
  ...
  const notifications = [
    {
      id: 1,
      message: "Suhu melebihi batas normal (32°C)",
      time: "2 menit lalu",
      read: false,
      type: "danger",
    },
    ...
    {
      id: 3,
      message: "Kebisingan terdeteksi (75dB)",
      time: "1 jam lalu",
      read: true,
      type: "info",
    },
              ...
              >
                <div className="dropdown-user-info">
                  ...
                  <div className="dropdown-user-details">
                    <span className="dropdown-fullname">
                      {user?.full_name || user?.username}
                    </span>
